# Video Slots — drop your 4 clips here
...
(like a frame sequence). Until a file exists, a charcoal placeholder with
grain + a motion diagram renders in its slot so everything stays testable.
